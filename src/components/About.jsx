...
const RangeInput = styled.input`
  ...
  appearance: none;
  height: 22px;
  background: linear-gradient(to right, #FEF538 0%, #FEF538 ${props => props.value}%, #FFFFFF ${props => props.value}%, #FFFFFF 100%);
  border-radius: 125px;
  outline: none;
...
const About = () => {
  ...
  const [tokensSold, setTokensSold] = useState(98_212_738);
  const [tokensRemaining, setTokensRemaining] = useState(80_212_738);

  const handleChange = (e) => {
    const newValue = e.target.value;
    setValue(newValue);
    const newTokensSold = Math.round((newValue / 100) * 178_425_476); // assuming total tokens is 178,425,476
    setTokensSold(newTokensSold);
    setTokensRemaining(178_425_476 - newTokensSold);
  };
  return (
    <section className=' bg-black position-relative section_margin' id='about'>
      ...
      <Container className='max_width_1140 z-1 aboutpadding_bottom'>
          ...
          <div className="AboutCard z-1">
            <Row className=" d-flex justify-content-between z-1 flex-column-reverse flex-lg-row">
              ...
              <Col lg={7} className=' d-flex justify-content-center' data-aos="zoom-in-left">
                <div className=" d-flex flex-column max_width_404 w-100">
                  <div className="d-flex  justify-content-between">
                    <div className="d-flex flex-column">
                      <h6 className=' font_Manrope fw-normal font_sm line_height_xmd white_smoke mb-0'>Tokens are Sold</h6>
                      <h5 className=' font_Manrope fw-bold  font_sm line_height_xmd color_yellow mb-0 range_value'>{tokensSold.toLocaleString()}</h5>
                    </div>
                  ...
                  <div className="pt-sm-3 pt-1  position-relative">
                    ...
                    <SliderContainer>
                      <RangeInput type="range" min="0" max="100" value={value} onChange={handleChange} />
                    </SliderContainer>
                  </div>
        ...
        <div className=" d-flex flex-column align-items-center justify-content-center z-1" data-aos="zoom-out-down">
          <h2 className=' mb-0 font_xl line_height_xl fw-semibold light_white aboutpadding_top z-1 font_Manrope'>About <span className=' color_yellow fw-bold'>$CLAIR</span></h2>
