...
import Nextsection from '../assets/images/webp/nextsection.png'
import { Container,Nav, NavLink } from 'react-bootstrap'
import Cart from '../assets/images/webp/cart.svg'
import Ellipse1L from '../assets/images/webp/Ellipse1L.png'
const HeroSection = () => {
      ...
      <nav className=' navigationDiv'>
       ...
       <div className=" d-flex gap_12">
        ...
        <Nav className={`${data ? "navShow" : "navhide"} d-flex align-items-center nav_gap mobile_view`}>
          ...
          <NavLink to ="#" className='p-0 font_sm fw-medium line_height_xmd font_Manrope white_smoke'>White Paper</NavLink>
        </Nav>
